...
\usepackage{xspace}             % allows for spacing in ensuremath

%custom colors:
\definecolor{forest}{RGB}{34, 145, 32}
...
\newcommand{\sinhalf}[1]{\sin\!\left( \frac{#1}{2} \right)}
\newcommand{\coshalf}[1]{\cos\!\left( \frac{#1}{2} \right)}
...
\newcommand{\ketz}[0]{\ensuremath{\ket{0}}\xspace}
\newcommand{\keto}[0]{\ensuremath{\ket{1}}\xspace}
\newcommand{\ketzz}[0]{\ensuremath{\ket{00}}\xspace} 
\newcommand{\ketzo}[0]{\ensuremath{\ket{01}}\xspace}
\newcommand{\ketoz}[0]{\ensuremath{\ket{10}}\xspace}
\newcommand{\ketoo}[0]{\ensuremath{\ket{11}}\xspace}

\newcommand{\braz}[0]{\ensuremath{\bra{0}}\xspace}
\newcommand{\brao}[0]{\ensuremath{\bra{1}}\xspace}
\newcommand{\brazz}[0]{\ensuremath{\bra{00}}\xspace} 
\newcommand{\brazo}[0]{\ensuremath{\bra{01}}\xspace}
\newcommand{\braoz}[0]{\ensuremath{\bra{10}}\xspace}
\newcommand{\braoo}[0]{\ensuremath{\bra{11}}\xspace}

\newcommand{\tbra}[1]{\ensuremath{\bra{#1}}\xspace}
\newcommand{\tket}[1]{\ensuremath{\ket{#1}}\xspace}

\newcommand{\ketp}[0]{\ensuremath{\ket{\psi}}\xspace}
\newcommand{\ketpp}[0]{\ensuremath{\ket{\psi'}}\xspace}
...
% 1st argument describes what comes in both sides (ket and bra) 2nd argument describes what comes in the middle.
...
\NewDocumentCommand{\ketbra}{O{\psi}}{%
   \ensuremath{
        \ket{#1} \bra{#1}
   }
}
...
\newcommand{\densop}{\ensuremath{\sumX_i p_i \ket{\psi_i} \bra{\psi_i}}}
\newcommand{\quop}{\ensuremath{\mathcal{E}(\rho)}}
